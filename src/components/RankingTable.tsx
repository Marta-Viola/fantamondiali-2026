    ...
    return (
        <div className="bg-white rounded-[1.5rem] sm:rounded-[2.5rem] shadow-xl overflow-hidden border border-emerald-100">
            <div className="w-full pb-2">
                {/* table-fixed è la chiave: forza la tabella a rispettare le nostre larghezze */}
                <table className="w-full text-left border-collapse table-fixed">
                    <thead className="bg-slate-50 border-b border-slate-100">
                        <tr>
                            ...
                            {/* w-full forza questa colonna a prendersi tutto lo spazio residuo per intero */}
                            <th className="py-3 px-2 sm:px-4 text-[9px] sm:text-[10px] font-black uppercase text-slate-400 w-full">
                                Nickname
                            </th>
                            <th className="py-3 px-1 sm:px-2 text-[8px] sm:text-[10px] font-black uppercase text-slate-400 text-center w-7 sm:w-16">
                            ...
                            <th className="py-3 px-1 sm:px-4 text-[9px] sm:text-[10px] font-black uppercase text-slate-400 text-center w-10 sm:w-20">
                                Punti
                            </th>
                        </tr>
                    </thead>
