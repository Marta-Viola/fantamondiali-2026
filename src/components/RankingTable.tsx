                                ...
                                >
                                    <td className="py-4 px-2 sm:px-8">
                                        <div className="flex flex-col items-center gap-0.5">
                                            ...
                                            <div className="h-2 flex items-center justify-center">
                                                ...
                                                {/* {hasPoints && diff > 0 && <span className="text-emerald-500 text-[9px] font-bold">▲</span>}
                                                {hasPoints && diff < 0 && <span className="text-rose-500 text-[9px] font-bold">▼</span>} */}
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="py-4 px-2 sm:px-4">
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-0 sm:gap-2">
                                            <span className={`text-[11px] sm:text-sm truncate max-w-[60px] xs:max-w-[80px] sm:max-w-none ${isMe ? 'font-black text-emerald-700' : 'font-bold text-slate-700'}`}>
